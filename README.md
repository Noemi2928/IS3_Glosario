# 📖 Glosario Colaborativo: Gestión de Configuración y Scrumban
...
* [Gestión de Configuración de Software (GCS)](./gcs/gcs.md)
    * [Ítem de Configuración](./gcs/item-de-configuracion.md)
    * [Línea Base (Baseline)](./gcs/linea-base.md)
    * [Versión](./gcs/version.md)
    * [Variante](./gcs/variante.md)
    * [Revisión](./gcs/revision.md)
...
* [Control del Cambio en la Configuración](./gcs/control-de-cambios-de-configuracion.md)
    ...
    * [Orden de Cambio](./gcs/orden-de-cambio.md)
...
* [Gestión de Liberación de Configuración](./gcs/gestion-de-liberaciones.md)
* [Control de Ítems de Configuración de Proveedores](./gcs/control-de-items-de-proveedores.md)
